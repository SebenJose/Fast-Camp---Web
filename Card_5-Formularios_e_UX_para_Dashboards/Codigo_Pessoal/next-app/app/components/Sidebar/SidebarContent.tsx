    ...
    <>
      <nav className="flex h-full w-full flex-col gap-4 overflow-hidden px-2 py-6">
        ...
        <div className="mt-auto">
          {!mounted ? (
            <div className="flex items-center gap-0 p-2 opacity-0">
              <div className="h-8 w-8 rounded-full bg-sidebar-accent/10" />
            </div>
          ) : session ? (
            <div className="flex items-center justify-between rounded-lg p-2">
              ...
              <Button
                ...
                className="shrink-0 opacity-100 transition-opacity md:opacity-0 md:group-hover/sidebar:opacity-100"
                aria-label="Sair"
              >
            ...
            <AuthModal>
              <button
                type="button"
                className="flex w-full cursor-pointer items-center rounded-lg p-2 text-left transition-all hover:bg-sidebar-accent/20"
              >
                <div className="flex w-8 shrink-0 items-center justify-center">
                  <Avatar className="h-8 w-8">
                    <AvatarImage
                ...
                <div className="ml-4 flex flex-col items-start overflow-hidden whitespace-nowrap opacity-100 transition-opacity duration-200 md:opacity-0 md:group-hover/sidebar:opacity-100">
                  <span className="text-sm font-medium text-sidebar-foreground">
                    Fazer Login
                  </span>
                  <span className="text-xs text-sidebar-foreground/70">
